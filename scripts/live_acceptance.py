...
def main():
    ...
    _, block, _ = client.request(
        ...
        {"title": "System Prompt", "content": "Answer in Traditional Chinese."},
    ...
    client.request(
        ...
        {"title": block["title"], "content": "Temporary change", "version": block["version"]},
        bearer=secret,
    )
    ...
    assert snapshot["blocks"][0]["content"] == "Answer in Traditional Chinese."
    ...
    assert detail["blocks"][0]["content"] == "Answer in Traditional Chinese."
